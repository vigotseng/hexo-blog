...
function sskadmin(e) {
	var ssk = '';
	if(e== '5596001'){
		ssk = '<span class="user_admin">Mod</span> '
	}
	return ssk;
}
!
    ...
    !e.DUOSHUO) {
        ...
        var X = {
            ...
            avatarUrl: function(e) {
                if (e.avatar_url) {
                    e.avatar_url = (document.location.protocol == "https:") ? e.avatar_url.replace(/http:\/\//g, "https://dn-comment.qbox.me/") : e.avatar_url
                } else {
                    nt.data.default_avatar_url = (document.location.protocol == "https:") ? nt.data.default_avatar_url.replace(/http:\/\//g, "https://dn-comment.qbox.me/") : nt.data.default_avatar_url
                }
        ...
        function() {
            ...
            at.SmiliesTooltip.prototype = {
                ...
                reset: function(e) {
                    function t(t, s) {
                        var i = 0 === e.indexOf("微博") ? "//dn-comment.qbox.me/img.t.sinajs.cn/t35/style/images/common/face/ext/normal/" + s.replace("_org", "_thumb") : j.STATIC_URL + "/images/smilies/" + s;
                        "WordPress" === e && (t = " " + t + " "),
